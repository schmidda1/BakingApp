...
public class MainActivityScreenTest2 {

    public static final String TITLE = "Recipe Introduction";
    ...
    public void clickRecyclerViewItem_OpensIngredientsStepsActivity(){
        ...
        onView(withId(R.id.steps_rv)).perform(RecyclerViewActions.scrollToPosition(0));
